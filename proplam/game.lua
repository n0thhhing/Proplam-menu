...
function yes()
 ...
 if (gameplay == 1) then
  ...
  function Hooky()
   ...
   local isharpoon = { { "0x2B8", gg.TYPE_BYTE, 1 }, { "0x2C8", gg.TYPE_FLOAT, 10 }, { "0x2D0", gg.TYPE_FLOAT, 15 },
    { "0x2D4", gg.TYPE_FLOAT, 9 } };
   local canbuy = { { "0x5D1", gg.TYPE_BYTE, 1 }, { "0x81", gg.TYPR_BYTE, 1 }, { "0x82", gg.TYPE_BYTE, 1 },
    { "0x80", gg.TYPE_BYTE, 1 }, { "0x83", gg.TYPE_BYTE, 1 } };
   ...
   if (hooks == 2) then
    function uti()
     ...
     local killAllActive = { { "0x369", gg.TYPE_BYTE, 1 }, { "0x36C", gg.TYPE_FLOAT, 5 },
     ...
     local roundMelee = { { "0x191", gg.TYPE_BYTE, 1 }, { "0x192", gg.TYPE_FLOAT, bigFloat },
     ...
     local invbl = { { "0x385", gg.TYPE_BYTE, 1 }, { "0x1E8", gg.TYPE_BYTE, 1 }, { "0x37C", gg.TYPE_BYTE, 1 },
      { "0x37D", gg.TYPE_BYTE, 1 }, { "0x380", gg.TYPE_FLOAT, bigFloat }, { "0x388", gg.TYPE_FLOAT, bigFloat } };
     function invis()
     ...
     local gundmgoffsets = { { "0x3BC", gg.TYPE_BYTE, 1 }, { "0x3C0", gg.TYPE_FLOAT, 2.5 }, { "0x3C4", gg.TYPE_FLOAT,
      5 }, { "0x3C8", gg.TYPE_FLOAT, 2.5 }, { "0x3CC", gg.TYPE_FLOAT, 50 } };
     function dmg()
     ...
     local godm = { { "0x311", gg.TYPE_BYTE, 1 }, { "0x1E9", gg.TYPE_BYTE, 1 }, { "0x1EA", gg.TYPE_BYTE, 1 },
      { "0x1EC", gg.TYPE_FLOAT, 9999 }, { "0x3EC", gg.TYPE_BYTE, 1 }, { "0x3F0", gg.TYPE_FLOAT, 100 },
      { "0x3F4", gg.TYPE_FLOAT, bigFloat }, { " 0x20D", gg.TYPE_BYTE, 1 }, { "0x5A4", gg.TYPE_BYTE, 1 },
      { "0x5A5", gg.TYPE_BYTE, 1 }, { "0x5A8", gg.TYPE_FLOAT, 9999 } };
     function godd()
     ...
     local rayx = { { "0x24B", gg.TYPE_BYTE, 1 }, { "0x24C", gg.TYPE_BYTE, 1 }, { "0x24D", gg.TYPE_BYTE, 1 },
      { "0x250", gg.TYPE_FLOAT, 0 }, { "0xC6", gg.TYPE_BYTE, 1 }, { "0xC5", gg.TYPE_BYTE, 1 } };
     function rays()
   ...
   if (hooks == 3) then
    function effective()
     ...
     local polymorpherOffsets = { { "0x2EC", gg.TYPE_BYTE, 1 }, { "0x2F0", gg.TYPE_FLOAT, bigFloat },
      { "0x3D8", gg.TYPE_DWORD, 0 }, { "0x2F8", gg.TYPE_FLOAT, bigFloat }, { "0x2B8", gg.TYPE_BYTE, 1 },
      { "0x2E0", gg.TYPE_FLOAT, bigFloat }, { "0x2D8", gg.TYPE_FLOAT, bigFloat } };
     ...
     local poison = { { "0x1F8", gg.TYPE_BYTE, 1 }, { "0x200", gg.TYPE_FLOAT, bigFloat },
     ...
     local isexplode = { { "0x318", gg.TYPE_BYTE, 1 }, { "0x324", gg.TYPE_FLOAT, bigFloat },
      { "0x31C", gg.TYPE_FLOAT, bigFloat }, { "0x320", gg.TYPE_FLOAT, 0 } };
     function death()
     ...
     local slow = { { "0x224", gg.TYPE_BYTE, 1 }, { "0x228", gg.TYPE_FLOAT, 10 }, { "0x22C", gg.TYPE_FLOAT, 9999 },
  ...
  function mode()
   ...
   if gmode == 2 then
    function runner()
     ...
     if race == 1 then
      if checkc == OFF then Patch(I[38], "E07B40B2C0035FD6")
       checkc = ON
      else
       Restore(I[38])
       checkc = OFF
